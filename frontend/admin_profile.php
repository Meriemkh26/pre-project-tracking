...
<body>
  ...
  <div class="navbar admin-nav">
    ...
    <div class="menu">
      ...
      <a href="admin_assign.html">Assign</a>
    </div>
    ...
    <div class="nav-right">
      ...
      <div class="user-menu" data-tooltip="Account">
        ...
        <div class="dropdown">
          <div class="dropdown-item" onclick="window.location.href='admin_profile.html'">
    ...
    <div class="big-card">
      ...
      <div class="profile-header">
        ...
        <div class="profile-info">
          ...
          <p id="profileEmail" style="color:#DE8389; font-size:13px;"></p>
        </div>
      </div>
      ...
      <div class="profile-form">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input class="form-input" type="text" id="editAdminLevel" placeholder="e.g. Super Admin">
          </div>
          <div class="form-group">
            <label for="editPermissions">Permissions</label>
            <input class="form-input" type="text" id="editPermissions" placeholder="e.g. Full Access">
          </div>
        </div>
